...
const UpdateNFT = () => {
  ...
  const tokenURIs = [
    'https://ipfs.io/ipfs/QmReWwhhRXu3LDQU9H3osN7gu5tkGQRaydmX7KcSRmA87M',
    'https://ipfs.io/ipfs/QmSPxiu9nRrxrnqbLmBrL2hdvrtS63YDZHfA3GVVW54fyB',
    'https://ipfs.io/ipfs/QmfAFPBdzJpQuiM1Bh5SXPpEuAd6sUh6BBB5RKjPA7b4vF',
  ];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#161616fd] py-6 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#1a1c1f' }}>
      <div className="max-w-7xl mx-auto w-full space-y-4">
        <div>
          <h2 className="text-center text-3xl font-extrabold text-white">NFT Update App</h2>
        </div>
        <div className="mb-4">
          ...
          {mintedTokenURI && (
            <div className="mt-8">
              <h3 className="text-xl font-bold text-white">Updated NFT:</h3>
              <div className="p-4 rounded-lg shadow-lg">
                <img src={mintedTokenURI} alt="Updated NFT" className="mx-auto mt-4 rounded-lg" style={{ maxWidth: '50%', width: '50%' }} />
              </div>
            </div>
          )}
        </div>
